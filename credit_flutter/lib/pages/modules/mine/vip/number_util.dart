/*
 * @Author: ws
 * @Date: 2021-05-24 15:09:10
 * @LastEditTime: 2021-05-24 15:18:14
 * @LastEditors: Please set LastEditors
 * @Description: 数字计算转换，精度正常
 * @FilePath: /credit_flutter/lib/common/number_util.dart
 */
...
class NumUtil {
  ...
  static String divideStrNum(num a, num b, int digits) {
    return divideDecStr((a).toString(), (b).toString()).toStringAsFixed(digits);
  }
  ...
  static num toDoubleAsFixed(num a, int digits) {
    return num.parse(Decimal.parse((a).toString()).toStringAsFixed(digits));
  }
  ...
  static Decimal divideDecStr(String a, String b) {
    var rational = Decimal.parse(a) / Decimal.parse(b);
    return rational as Decimal;
  }
