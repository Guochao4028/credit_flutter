...
class PartReportDetailsPage extends StatefulWidget {
  String reportId;
  String authId;

  PartReportDetailsPage(
      {Key? key, required this.reportId, required this.authId})
      : super(key: key);

  @override
  State<PartReportDetailsPage> createState() => _PartReportDetailsPageState();
}

class _PartReportDetailsPageState extends State<PartReportDetailsPage> {
  //名称
  String name = "";
  ...
  void _initData(String reportId) async {
    ReportDetailsManager.getPartReportData(reportId, (object) {
      var data = object as PartialReportModel;
      ...
      //年龄
      age = data.inputMap.age.toString();
      ...
      //运营商
      var itemData120 = data.detail.operatorHours.itemData120;
